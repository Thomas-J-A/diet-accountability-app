...
import { Text, Quote, Em, Link } from '@radix-ui/themes';
...
const QuestionsAccordion = () => {
  return (
    <Accordion.Root type="single" collapsible>
      ...
      <AccordionItem value="item-5" triggerText="Will this app steal my data?">
      ...
      <AccordionItem value="item-7" triggerText="Where can I file a complaint?">
        <Text size={{ initial: '1', md: '2' }} weight="light">
